...
const Cart = () => {
    ...
    const {foodList,increaseQty, descreaseQty, quantities, removeFromCart } = useContext(StoreContext);
                ...
                <div className="card-body">
                    {
                        ...
                        <div className="col-md-2">
                            <div className="input-group">
                                ...
                                onClick={()=>descreaseQty(food.id)}
                                >-</button>
                                <input style={{"max-width":"100px"}} type="text" className="form-control  form-control-sm text-center quantity-input" value={quantities[food.id]} readOnly/>
                                <button className="btn btn-outline-secondary btn-sm" type="button"
            ...
            <div className="card cart-summary">
                <div className="card-body">
                    ...
                    <div className="d-flex justify-content-between mb-4">
                        <strong>Total</strong>
                        <strong>&#8377;{subtotal===0?0:total}</strong>
                    </div>
